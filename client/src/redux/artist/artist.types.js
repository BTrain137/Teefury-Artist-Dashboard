const ArtistActionTypes = {
  ...
  // Submit Artwork
  ARTWORK_SUBMIT_START: "ARTWORK_SUBMIT_START",
  ARTWORK_SUBMIT_SUCCESS: "ARTWORK_SUBMIT_SUCCESS",
  ARTWORK_SUBMIT_ADD: "ARTWORK_SUBMIT_ADD",
  ARTWORK_SUBMIT_FAILURE: "ARTWORK_SUBMIT_FAILURE",
